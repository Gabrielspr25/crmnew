...
const auditIpMigration = readFileSync(new URL('migrations/2026-08-10-audit-log-ip-address.sql', root), 'utf8');
...
test('audit_log stores the requester IP address', () => {
  ...
  assert.match(auditIpMigration, /ADD COLUMN IF NOT EXISTS ip_address TEXT/i);
