...
const { parseOperationalWorkbook } = require('../../frontend/import-workbook.js');
...
test('consolida Empresa y Email por BAN sin duplicar las filas convergentes', () => {
  const parsed = parseOperationalWorkbook(workbook({
    MOvil: [
      ['Empresa', 'BAN', 'SUB', 'SUB_STATUS', 'SOC', 'Email'],
      ['ACME LLC', '712345678', '7871111111', 'A', 'BREDP2', 'acme@example.com'],
      ['', '712345678', '7872222222', 'S', 'BREDP2', ''],
    ],
    Fijos: [
