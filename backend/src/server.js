...
import { beneficiosReglasRouter } from './routes/beneficiosReglasRoutes.js';
...
app.use('/api/beneficios-reglas', beneficiosReglasRouter); // reglas/bonos editables (sin hardcodeo)
